...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        # 4a: Write an if statement that checks that the county does
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_list:
        ...
        county_results = (f"{county}: {county_vote_percentage:.1f}%"
                          f"({county_vote:,})\n"
                          )
    ...
    winning_candidate_summary = (f"-------------------------\n"
                                 ...
                                 f"Winning Percentage:"
                                 f"{winning_percentage:.1f}%\n"
                                 f"-------------------------\n"
                                 )
